...
export class startMenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(this.game.renderer.width * 0.2, this.game.renderer.height * 0.1, "title").setDepth(1).setOrigin(0);

        const playButton = this.add.image(this.game.renderer.width * 0.2, this.game.renderer.height * 0.8, "playButton").setDepth(1);
        ...
        const scoreButton = this.add.image(this.game.renderer.width * 0.55, this.game.renderer.height * 0.8, "scoreButton").setDepth(1);
